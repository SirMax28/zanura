        ...
        <div className="fixed inset-0 z-[60] flex justify-end">
          ...
          >
            ...
            <div className="flex justify-between items-center px-8 py-6 border-b border-zanura-sand">
              <h2 className="font-serif text-xl tracking-widest uppercase text-zanura-blue text-center w-full">
                Tu Carrito
              </h2>
              <button
                onClick={onClose}
              ...
              >
                <X
                  size={20}
                  className="text-gray-500 group-hover:text-zanura-black transition-colors group-hover:rotate-90 duration-300"
                  strokeWidth={1.5}
                />
              </button>
            </div>
            ...
            <div className="p-8 bg-white border-t border-zanura-sand space-y-4">
              ...
              <p className="text-[10px] text-gray-400 text-center uppercase tracking-widest mb-4">
